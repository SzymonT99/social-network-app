...
export const endpoints = {
  ...
  manageUserInterests: baseUrl + '/api/profile/{userId}/interests/{interestId}',
  manageProfilePhoto: baseUrl + '/api/profile/{userId}/photo',
  profileImages: baseUrl + '/api/profile/{userId}/images',
  profileInformation: baseUrl + '/api/profile/{userId}/information',
